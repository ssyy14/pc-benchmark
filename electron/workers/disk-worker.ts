...
const SEQ_SIZE = 256 * 1024 * 1024
const BLOCK_4K = 4096
const RANDOM_IO_COUNT = 5000
const RANDOM_SIZE = 512 * 1024 * 1024
...
async function run(): Promise<void> {
  ...
  try {
    ...
    for (let i = 0; i < RANDOM_IO_COUNT; i++) {
      positions.push(Math.floor(Math.random() * (RANDOM_SIZE / BLOCK_4K)) * BLOCK_4K)
    }
